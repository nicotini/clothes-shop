...
<head>
    <meta charset="utf-8">
    <title>Becute - Shop Left Sidebar</title>
        ...
        <div class="offcanvas__filter--sidebar__inner">
                    ...
                    <li class="widget__categories--menu__list">
                        <label class="widget__categories--menu__label d-flex align-items-center">
                            <img class="widget__categories--menu__img"
                                src="assets/img/product/small-product/product1.webp" alt="categories-img">
            ...
            <div class="single__widget widget__bg">
                ...
                <ul class="widget__form--check">
                    <li class="widget__form--check__list">
                        <label class="widget__form--check__label" for="check6">Bath & Body</label>
                        <input class="widget__form--check__input" id="check6" type="checkbox">
                        <span class="widget__form--checkmark"></span>
                    </li>
                    <li class="widget__form--check__list">
                        <label class="widget__form--check__label" for="check7">Hair Care</label>
                        <input class="widget__form--check__input" id="check7" type="checkbox">
                        <span class="widget__form--checkmark"></span>
                    </li>
                    <li class="widget__form--check__list">
                        <label class="widget__form--check__label" for="check8">Make Up</label>
                        <input class="widget__form--check__input" id="check8" type="checkbox">
                        <span class="widget__form--checkmark"></span>
                    </li>
                    <li class="widget__form--check__list">
                        <label class="widget__form--check__label" for="check9">Health Care</label>
                        <input class="widget__form--check__input" id="check9" type="checkbox">
                        <span class="widget__form--checkmark"></span>
                    </li>
                    <li class="widget__form--check__list">
                        <label class="widget__form--check__label" for="check10">Styling Products</label>
                        ...
                        <div class="price__filter--group">
                            ...
                            <div class="price__filter--input border-radius-5 d-flex align-items-center">
                                ...
                                <input class="price__filter--input__field border-0" name="filter.v.price.gte"
                                    id="Filter-Price-GTE1" type="number" placeholder="0" min="0"
                                    max="250.00">
                            </div>
                        </div>
                        ...
                        <div class="price__filter--group">
                            ...
                            <div class="price__filter--input border-radius-5 d-flex align-items-center">
                                ...
                                <input class="price__filter--input__field border-0" name="filter.v.price.lte"
                                    id="Filter-Price-LTE1" type="number" min="0" placeholder="250.00"
                                    max="250.00">
                            </div>
                        </div>
                    </div>
            ...
            <div class="single__widget widget__bg">
                ...
                <div class="shop__sidebar--product">
                    <div class="small__product--card d-flex">
                        <div class="small__product--thumbnail">
                            <a class="display-block" href="product-details.html"><img
                                    src="assets/img/product/small-product/product1.webp" alt="product-img"></a>
                        </div>
                        <div class="small__product--content">
                            <h3 class="small__product--card__title"><a href="product-details.html">White Cream </a>
                            </h3>
                    ...
                    <div class="small__product--card d-flex">
                        <div class="small__product--thumbnail">
                            <a class="display-block" href="product-details.html"><img
                                    src="assets/img/product/small-product/product2.webp" alt="product-img"></a>
                        </div>
                        <div class="small__product--content">
                            <h3 class="small__product--card__title"><a href="product-details.html">Sneaky lips </a>
                            </h3>
                            <div class="small__product--card__price mb_5">
                    ...
                    <div class="small__product--card d-flex">
                        <div class="small__product--thumbnail">
                            <a class="display-block" href="product-details.html"><img
                                    src="assets/img/product/small-product/product3.webp" alt="product-img"></a>
                        </div>
                        <div class="small__product--content">
                            <h3 class="small__product--card__title"><a href="product-details.html">Matte Walnut </a>
                            </h3>
                            <div class="small__product--card__price mb_5">
            ...
            <div class="single__widget widget__bg">
                ...
                <ul class="widget__tagcloud">
                    ...
                    <li class="widget__tagcloud--list"><a class="widget__tagcloud--link" href="shop.html">Make Up</a>
                    </li>
                    <li class="widget__tagcloud--list"><a class="widget__tagcloud--link" href="shop.html">Skin
                            Care</a></li>
                    <li class="widget__tagcloud--list"><a class="widget__tagcloud--link" href="shop.html">Styling
                        </a></li>
                    <li class="widget__tagcloud--list"><a class="widget__tagcloud--link" href="shop.html">Products
                        </a></li>
                    <li class="widget__tagcloud--list"><a class="widget__tagcloud--link"
                            href="shop.html">Fairness</a></li>
                    <li class="widget__tagcloud--list"><a class="widget__tagcloud--link" href="shop.html">Cream Oil
                        </a></li>
                    <li class="widget__tagcloud--list"><a class="widget__tagcloud--link" href="shop.html">Matte
                            Walnut </a></li>
                </ul>
            </div>
        </div>
                    ...
                    <div class="header__top--right d-flex align-items-center">
                       @auth
                        <ul class="header__top--link d-flex align-items-center">
                            <li class="header__link--menu"><a class="header__link--menu__text" href="{{route('order.index')}}">
                        ...
                        <li class="offcanvas__menu_li">
                            ...
                            <ul class="offcanvas__sub_menu">
                                <li class="offcanvas__sub_menu_li"><a href="index.html"
                                        class="offcanvas__sub_menu_item">Home - Beauty Cosmetic</a></li>
                                <li class="offcanvas__sub_menu_li"><a href="index-2.html"
                                        class="offcanvas__sub_menu_item">Home - Cosmetic Spa</a></li>
                                <li class="offcanvas__sub_menu_li"><a href="index-3.html"
                                        class="offcanvas__sub_menu_item">Home - Jewelry Store</a></li>
                                <li class="offcanvas__sub_menu_li"><a href="index-4.html"
                                        class="offcanvas__sub_menu_item">Home - Modern Jewelry</a></li>
                                <li class="offcanvas__sub_menu_li"><a href="index-5.html"
                                        class="offcanvas__sub_menu_item">Home - Look book</a></li>
                                <li class="offcanvas__sub_menu_li"><a href="index-6.html"
                                        class="offcanvas__sub_menu_item">Home - Beauty Jewelers</a></li>
                                <li class="offcanvas__sub_menu_li"><a href="index-7.html"
                                        class="offcanvas__sub_menu_item">Home - Parallax</a></li>
                            </ul>
                        </li>
                        <li class="offcanvas__menu_li">
                ...
                <li class="offcanvas__sticky--toolbar__list">
                    <a class="offcanvas__sticky--toolbar__btn" href="index.html">
                        <span class="offcanvas__sticky--toolbar__icon">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" width="21.51"
                            ...
                            <div class="footer__widget--inner">
                                <div class="footer__logo">
                                    <a class="footer__logo--link" href="index.html">
                                        <img class="footer__logo--img" src="assets/img/logo/nav-log.webp"
                                            alt="logo-img">
                                    </a>
                                </div>
                                ...
                                <ul class="footer__widget--info">
                                    <li class="footer__widget--info_list">
                                        ...
                                        <span class="footer__widget--info__text">Brooklyn, New York, United
                                            States</span>
                                    </li>
                                    <li class="footer__widget--info_list">
                                        ...
                                        <a class="footer__widget--info__text" href="tel:+1234567898">: (+123)
                                            456-7898</a>
                                    </li>
                                    <li class="footer__widget--info_list">
                        ...
                        <div class="col">
                            <div class="quickview__info">
                                <form action="#">
                                    ...
                                    <p class="product__details--info__desc mb-15">Lorem ipsum dolor sit amet,
                                        consectetur adipisicing elit is. Deserunt totam dolores ea numquam labore!.</p>
