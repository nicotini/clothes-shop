                                        ...
                                        <tbody class="account__table--body mobile__none">
                                            @foreach ($orders as $order)
                                                <tr class="account__table--body__child">
                                                    <td class="account__table--body__child--items"><a href="{{ route('order.show', $order->id)}}">{{ $order->order_number }}</a></td>
                                                    ...
                                                    <td class="account__table--body__child--items">{{ $order->total_sum}}</td>
                                                </tr>
                                            @endforeach
                                        </tbody>
