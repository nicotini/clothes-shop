             ...
             <div class="shop__collection--column5 swiper">
                 <div class="swiper-wrapper">
                     ...
                     <div class="swiper-slide">
                         <div class="shop__collection--card text-center">
                             <a class="shop__collection--link" href="shop.html">
                                 <img class="shop__collection--img" src="assets/img/collection/collection8.webp"
                                     alt="icon-img">
                     ...
                     <div class="swiper-slide">
                         <div class="shop__collection--card text-center">
                             <a class="shop__collection--link" href="shop.html">
                                 <img class="shop__collection--img" src="assets/img/collection/collection9.webp"
                                     alt="icon-img">
                     ...
                     <div class="swiper-slide">
                         <div class="shop__collection--card text-center">
                             <a class="shop__collection--link" href="shop.html">
                                 <img class="shop__collection--img" src="assets/img/collection/collection10.webp"
                                     alt="icon-img">
                     ...
                     <div class="swiper-slide">
                         <div class="shop__collection--card text-center">
                             <a class="shop__collection--link" href="shop.html">
                                 <img class="shop__collection--img" src="assets/img/collection/collection11.webp"
                                     alt="icon-img">
