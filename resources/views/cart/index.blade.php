                        ...
                        <div class="col-lg-8">
                            <div class="cart__table">
                                            ...
                                            <tr class="cart__table--body__items">
                                                <td class="cart__table--body__list">
                                                    <div class="cart__product d-flex align-items-center">
                                                        <form method="post"
                                                            action="{{ route('cart.delete', $cartItem->product_id) }}"
                                                            id="delete_cart_{{ $cartItem->product_id }}">
                                                            @csrf
                                                            @method('delete')
                                                            <button class="cart__remove--btn" aria-label="search button"
                                                                form="delete_cart_{{ $cartItem->product_id }}"
                                                                type="submit">
                                                                ...
                                                                @foreach ($cartItem->product->productAttributes->unique('attribute_id') as $attr)
                                                                    @foreach ($attributes as $attribute => $attributeValue)
                                                                        @if ($attr->attribute_id == $attribute)
                                                                            <span
                                                                                class="cart__content--variant">{{ $attr->attribute->name }}:
                                                ...
                                                <td class="cart__table--body__list">
                                                    <form method="post" action="{{ route('cart.update', $cartItem->product->id) }}"
                                                        id="cart_amount_update_{{ $cartItem->product->id }}">
                                                        @csrf
                                                        @method('patch')
                                                        <div class="quantity__box">
                                                            ...
                                                            <label>
                                                                <input type="number"
                                                                    ...
                                                                    name="product_quantity" data-counter />
                                                            </label>
                                                            <button type="button"
                                                        ...
                                                        <button class="cart__summary--footer__btn primary__btn cart"
                                                            type="submit"
                                                            form="cart_amount_update_{{ $cartItem->product->id }}">Update
                                                            Cart</button>
                                                    </form>
                                                </td>
                                ...
                                <div class="continue__shopping d-flex justify-content-between">
                                    <a class="continue__shopping--link" href="{{ route('shop.index') }}">Continue
                                        shopping</a>

                                    <form action="{{ route('cart.delete.cart') }}" method="POST" id="clear_cart">
                                        @csrf
                                        @method('delete')
                                        <button class="continue__shopping--clear" type="submit" form="clear_cart">Clear
                                            Cart</button>
                                    </form>
                                </div>
                            </div>
                    ...
                    <div class="swiper-slide">
                        <article class="product__card">
                            ...
                            <div class="product__card--content text-center">
                                ...
                                <h3 class="product__card--title"><a href="product-details.html">Quis nihil modi dn venia
                                        vel ac? </a></h3>
                                <div class="product__card--price">
